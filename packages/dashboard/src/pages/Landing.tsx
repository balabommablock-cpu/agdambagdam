...
const COMP_ROWS: CompRow[] = [
  ...
  { feature: 'CUPED Variance Reduction', ab: 'yes',    vwo: 'no',   optimizely: 'no',   launchdarkly: 'no',    statsig: 'yes',  growthbook: 'paid', bold: true },
  ...
  { feature: 'Multi-Armed Bandits',      ab: 'yes',    vwo: 'no',   optimizely: 'yes',  launchdarkly: 'no',    statsig: 'yes',  growthbook: 'paid', bold: true },
  { feature: 'Contextual Bandits',       ab: 'yes',    vwo: 'no',   optimizely: 'no',   launchdarkly: 'no',    statsig: 'yes',  growthbook: 'no', bold: true },
